classdef genrou < Components
    %GENROU Initializes all generators of type GENROU and updates generator states during simulation. 
    ...
    methods
       ...
       function [gen,pmech,ifd]=Init(gen,eD,eQ,iD,iQ)
        ...
        function [gen,eq1,ed1,ifd] = newStates(gen,tspan,pmech1,id1,iq1,ed,eq,efd1)
            ...
            eqd=([-gen.xd11 -gen.ra;gen.ra -gen.xq11]*[id1;iq1]+[psid110;psiq110]); 
            eq1=eqd(1);
            ed1=-eqd(2);
        end
    end
